...
public class SwerveModule {
    ...
    /**
     * This methods returns turn encoder velocity in ticks per 100ms.
     * 
     * @param selectedEncoder
     * @return value of selected encoder
     */
    public double getDriveEncoderVelocityTicks() {
    ...
    // TO DO SATURDAY;
    // In theory, should return inches per second
    public double getSpeed(double ticksVelocity, double wheelDiameter) {
        ...
        // In theory, should return inches per 100ms
        /*
         * double radius = wheelDiameter / 2;
         * double turnsPer100MS = driveMotor.getSelectedSensorVelocity();
         * double speed = turnsPer100MS * ((2 * Math.PI * radius) /
    ...
    // travel distance. gear ratio A:1 means, 1/A. //Assuming all motors have same
    // encoder per ticks.
    ...
    // Gives back the distance of the drive motor and the angle of the turn motor,
    // as a swerve Module state Object
    public SwerveModuleState getModuleState() {
        return new SwerveModuleState(getSpeed(getDriveEncoderVelocityTicks(), Constants.wheelDiameter),
                new Rotation2d(getAngle() / (2 * 3.1416)));
    };
}
